...
{
    // This class contains Static Details that are used in various places of the application
    public static class SD
    {
        ...
        public const string CartSesh = "Shopping Cart Session";
        ...
        // Calculate the price of the book based on the quantity being sold
